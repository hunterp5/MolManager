...
This folder contains small example datasets you can load into **ChemManager**.
...
The sample includes a `SMILES` column, so ChemManager will render structures automatically.
