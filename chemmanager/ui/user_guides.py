"""In-app HTML user guides for ChemManager menus, tools, and external integrations."""
...
_GUIDE_HTML: dict[str, str] = {
    "overview": """
<h2>ChemManager overview</h2>
<p>ChemManager is a desktop compound table built on <b>PyQt5</b> and <b>RDKit</b>. Each row is a record;
...
<b>New Session</b> clears and starts fresh (with confirmation if needed). <b>Duplicate Session</b> opens a second ChemManager window with a copy of the data.</p>
...
(<code>CHEMMANAGER_DISABLE_CUSTOM_CALC</code>).</p>
...
def open_user_guide_dialog(parent: QWidget | None, guide_id: str = "overview") -> None:
    ...
    dlg = QDialog(parent)
    dlg.setWindowTitle("ChemManager — user guides")
    dlg.resize(760, 520)
