...
class PlotlyInteractiveView(QWidget):
    ...
    def __init__(self, parent_app: ChemicalTableApp | None = None, parent: QWidget | None = None) -> None:
        ...
        self._plot_shell_path = Path(tempfile.gettempdir()) / f"chemmanager_plot_shell_{id(self)}.html"
    ...
    def sync_selection_visual(self) -> None:
        ...
        self.web.page().runJavaScript(f"window.chemmanagerSetSelection({js_arg});")
...
<body>
  ...
  <script>
    (function() {{
      ...
      window.chemmanagerSetSelection = function(indicesJson) {{
        try {{
      ...
      window.chemmanagerApply = function(payloadJson) {{
        try {{
          ...
          console.error('ChemManager Plotly embed failed:', e);
        }}
      }};
    }})();
  </script>
    ...
    def _apply_pending_payload(self) -> None:
        ...
        self.web.page().runJavaScript(f"window.chemmanagerApply({js_arg});")
        self._arm_ignore_plot_clear()
    ...
    def _on_web_load_finished(self, ok: bool) -> None:
        ...
        QTimer.singleShot(
            ...
            lambda: self.web.page().runJavaScript(
                "typeof window.Plotly !== 'undefined' && typeof window.chemmanagerApply === 'function'",
                _after_probe,
            ),
        )
